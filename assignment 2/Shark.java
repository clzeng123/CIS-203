/**
 * Shark make randome move and display name.
 *
 * Shark has one default constructor that intialize the count,
...
public class Shark implements Ocean{
    int count;
    int move;
    int index;
    ...
    public int getMove(OceanInfo info) {
        int[] direction = {Ocean.SOUTH,Ocean.EAST,Ocean.NORTH,
                            Ocean.EAST,};
        if(count % 4 == 0){
